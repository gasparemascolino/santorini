package com.gasparemascolino.controller;
...
public class WorkerControllerTest {
    ...
    public void MoveTest(){
        ...
        WorkerController.Move(player.getWorker(1),1,1,board);
    ...
    public void BuildTest() {
        ...
        WorkerController.Build(player.getWorker(1),1,1,board);
    ...
    public void enableToMoveTest() {
        ...
        while ( WorkerController.enableToMove(player.getWorker(1),board)[k]!=null ) {
            Assert.assertNotEquals(WorkerController.enableToMove(player.getWorker(1),board)[k], board.cell[1][2]);
            k++;
        }
        ...
        k=0;
        while (WorkerController.enableToMove(player.getWorker(1),board)[k]!=null ) {
            Assert.assertNotEquals(WorkerController.enableToMove(player.getWorker(1),board)[k], board.cell[2][2]);
            k++;
        }
        ...
        while (WorkerController.enableToMove(player.getWorker(1),board)[k]!=null ) {
            ...
            if(WorkerController.enableToMove(player.getWorker(1),board)[k].equals(board.cell[2][1]))
                flag = 1;
    ...
    public void enableToBuildTest() {
        ...
        int k=0;
        while (WorkerController.enableToBuild(player.getWorker(1),board)[k]!=null ){
            Assert.assertNotEquals(WorkerController.enableToBuild(player.getWorker(1),board)[k], board.cell[1][2]);
            k++;
        }
    ...
    public void enemyPositionsTest() {
        ...
        Cell[] enemyposition = WorkerController.enemyPositions(player1.getWorker(1), board);
